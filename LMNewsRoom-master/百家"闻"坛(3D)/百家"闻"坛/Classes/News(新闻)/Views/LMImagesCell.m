...
- (void)setNews:(LMNews *)news {
    ...
    [self.iconImageView sd_setImageWithURL:[NSURL URLWithString:news.imgsrc] placeholderImage:[UIImage imageWithOriginalName:@"placeholder"]];
    [self.secondImageView sd_setImageWithURL:[NSURL URLWithString:news.imgextra[0][@"imgsrc"]] placeholderImage:[UIImage imageWithOriginalName:@"placeholder"]];
    [self.thirdImageView sd_setImageWithURL:[NSURL URLWithString:news.imgextra[1][@"imgsrc"]] placeholderImage:[UIImage imageWithOriginalName:@"placeholder"]];
