...
@interface LMNewsViewController ()<UIScrollViewDelegate>
/**
 *  标题栏滚动视图
 */
...
@implementation LMNewsViewController
...
- (void)setUpTitleView {
    ...
    titleImageView.image = [UIImage imageNamed:@"news"];
...
- (void)addBackGroudImageView {
    ...
    backImageView.image = [UIImage imageNamed:@"placeholder"];
